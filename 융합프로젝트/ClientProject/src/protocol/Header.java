...
public class Header implements MySerializableClass
{
    ...
    public final static byte CODE_SERVER_REQ_ADD_STORE = 1;//가게추가요청(매니져
    public final static byte CODE_SERVER_REQ_REGIST_MENU = 2;//메뉴등록요청(매니져
    ...
    public final static byte CODE_OWNER_REQ_DISCNT_POLICY = 8;//할인11정책
    ...
    public final static byte CODE_MANAGER_REFER_RE_STORE_SALES = 19;//가게매출조회
    ...
    public final static byte CODE_CUSTOMER_REFER_REQ_STORE = 26;//음식점단일조회
    public final static byte CODE_SERVER_REFER_REQ_MENU_LIST = 27; //메뉴 조회
    public final static byte CODE_OWNER_REQ_SIGNUP = 28; //점주 회원가입
    public final static byte CODE_OWNER_REQ_REPLY_ANSWER = 29; //답글등록할 번호랑 답글내용
    public final static byte CODE_MANAGER_REQ_STORE_ACCEPT = 30; //가게승인
    public final static byte CODE_MANAGER_REQ_MENU_ACCEPT = 31; //메뉴승인
    //public final static byte CODE_OWNER_REQ_HOLD_ORDERLIST = 32; //점주가 주문 리스트 받음
    public final static byte CODE_CUSTOMER_REQ_CANCANCEL_LIST = 33; //취소 가능한 리스트 전송
...
public final static byte CODE_OWNER_REQ_ADD_MENUOPTION = 36; //옵션 등록신청
    public final static byte CODE_OWNER_REQ_AND_DELIVERY = 37; //배달완료
    public final static byte CODE_CUSTOMER_REQ_MENUOPTIONLIST = 38; // 메뉴옵션 리스트
    public final static byte CODE_OWNER_REQ_CAN_DELIVERYLIST = 39; //배달완료 리스트
...
public final static byte CODE_CUSTOMER_REQ_MY_REVIEW = 42;
    ...
    public final static byte CODE_SERVER_REFER_RES_OWNER_STORE_LIST = 8;//가게목록정보(관리자에대한답변)
    ...
    public final static byte CODE_SERVER_REFER_RES_STORE_INFO = 14;//가게정보(점주에대한답변)
    public final static byte CODE_SERVER_REFER_RES_STORE = 15;//음식점단일조회
    public final static byte CODE_SERVER_REFER_RES_MENU_LIST = 16; //메뉴 조회
    public final static byte CODE_SERVER_RES_CANREVIEWLIST = 17; // 답글가능한 리뷰리스트 전송
    ...
    public final static byte CODE_SERVER_REQ_CANACCEPT_ORDER_LIST = 22; //주문 접수 가능한 주문 리스트
